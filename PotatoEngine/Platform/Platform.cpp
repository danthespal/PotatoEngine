...
resize_window(window_id id, u32 width, u32 height)
{
    ...
    // NOTE: whenI host the window in the level editorI just update
    ...
    {
        // NOTE:I also resize while in fullscreen mode to support the case
...
create_window(const window_init_info* const init_info /* = nullptr */)
{
    ...
    wc.lpszClassName = L"PotatoWindow";
